...
require "active_record/connection_adapters/oracle_enhanced/compatibility_strategy"
...
module ActiveRecord
  module ConnectionAdapters # :nodoc:
    ...
    class OracleEnhancedAdapter < AbstractAdapter
      ...
      #
      # Defaults to +false+: <tt>Migration[8.2]+</tt> migrations, +Schema.define+,
      # and direct adapter calls create the unique index only. <tt>Migration[8.1]</tt>
      # and earlier still receive the implicit constraint via +CompatibilityStrategy+
      # so existing migrations keep working unchanged. Set to +true+ to force the
      # legacy implicit-constraint behavior project-wide:
      #
      ...
      def compatibility_strategy_for(migration_class) # :nodoc:
        OracleEnhanced::CompatibilityStrategy.for(migration_class)
      end
